...
class ViewController extends \Slim\View
{
    ...
    {
        define("TEMPLATES_ROOT", APP_ROOT . "/themes/Base/");
        $template = TEMPLATES_ROOT . '/templates/' . $template;
        ...
        ob_start();
        $wrapper_template = TEMPLATES_ROOT . "/templates/wrapper/main.phtml";
    ...
    public function translate($string, $replacements = array()){
        return \Thru\Translation\Translation::getInstance()->translate($string, $replacements);
    }
